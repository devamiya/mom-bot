...
const data = [{'summary_text': 'Amiya Panigrahi is running 10 minutes late.\n Megan Bowen is already occupied with the Canada Task.'}]
    ...
    for (const target of await bot.notification.installations()) {
      await target.sendAdaptiveCard(
        AdaptiveCards.declare(notificationTemplate).render({
          title: "Your Meeting Summarizer",
          appName: "Momaizer",
          description: data[0].summary_text,
          notificationUrl: "mailto:eee.amiya@outlook.com",
        })
      );
    }
